...
# ←←← YAHAN APNA TOKEN DAAL DO (ya Vercel env mein BOT_TOKEN set kar do)
...
@app.get("/")
async def home():
    return {"status": "TeraBox Bot Live on Vercel!"}
